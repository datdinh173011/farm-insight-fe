    ...
    >
      ...
      <div className={styles.formSectionBg}>
        <div className={styles.row}>
          <Form.Item name="ngayBatDau" label="Ngày bắt đầu" rules={[{required:true,message:'Bắt buộc nhập'}]} className={styles.col}><Input /></Form.Item>
          <Form.Item name="soLuaTrunQue" label="Số lứa trùn quế đã nuôi" rules={[{required:true,message:'Bắt buộc nhập'}]} className={styles.col}><InputNumber min={0} style={{width:'100%'}} /></Form.Item>
        </div>
        <div className={styles.row}>
          <Form.Item name="soNgayMotLua" label="Số ngày để nuôi một lứa trùn quế (bắt đầu thả sinh khối – thu hoạch, TB 60 ngày)" rules={[{required:true,message:'Bắt buộc nhập'}]} className={styles.col}><InputNumber min={0} style={{width:'100%'}} /></Form.Item>
          <Form.Item name="tongChiPhiXayDung" label="Tổng chi phí xây dựng khu nuôi trùn quế (bao gồm vật liệu và nhân công)" rules={[{required:true,message:'Bắt buộc nhập'}]} className={styles.col}><InputNumber min={0} style={{width:'100%'}} /></Form.Item>
        </div>
        <div className={styles.row}>
          <Form.Item name="chiPhiMuaGiong" label="Chi phí mua giống (sinh khối trùn quế)" rules={[{required:true,message:'Bắt buộc nhập'}]} className={styles.col}><InputNumber min={0} style={{width:'100%'}} /></Form.Item>
          <Form.Item name="chiPhiDauVaoKhac" label="Chi phí đầu vào/vật liệu khác (cho Trùn quế)" rules={[{required:true,message:'Bắt buộc nhập'}]} className={styles.col}><InputNumber min={0} style={{width:'100%'}} /></Form.Item>
        </div>
        <div className={styles.row}>
          <Form.Item name="cachSuDungTrunQue" label="Cách sử dụng trùn quế" rules={[{required:true,message:'Bắt buộc nhập'}]} className={styles.col}>
      ...
      {/* Section B, C, D would follow similar structure, with grouped backgrounds and sub-fields as described. For brevity, only section A is fully implemented here. */}
          ...
          <div className={styles.formSectionBg}>
            <div className={styles.row}>
              <Form.Item name="loaiPhuPhamThucAn" label="Loại phụ phẩm nông nghiệp làm thức ăn cho trùn quế" rules={[{required:true,message:'Bắt buộc nhập'}]} className={styles.col}><Input /></Form.Item>
              <Form.Item name="khoiLuongPhuPhamTB" label="Khối lượng phụ phẩm nông nghiệp thải trung bình mỗi ngày (kg/con/ngày)" rules={[{required:true,message:'Bắt buộc nhập'}]} className={styles.col}><InputNumber min={0} style={{width:'100%'}} /></Form.Item>
            </div>
            <div className={styles.row}>
              <Form.Item name="soLuongVatNuoi" label="Số lượng từng loại vật nuôi" rules={[{required:true,message:'Bắt buộc nhập'}]} className={styles.col}><Input /></Form.Item>
              <Form.Item name="soNgayLuaNuoi" label="Số ngày/lứa nuôi" rules={[{required:true,message:'Bắt buộc nhập'}]} className={styles.col}><InputNumber min={0} style={{width:'100%'}} /></Form.Item>
            </div>
            <div className={styles.row}>
              <Form.Item name="soLuaNuoi" label="Số lứa nuôi" rules={[{required:true,message:'Bắt buộc nhập'}]} className={styles.col}><InputNumber min={0} style={{width:'100%'}} /></Form.Item>
              <Form.Item name="tongKhoiLuongPhuPhamSX" label="Tổng khối lượng phụ phẩm nông nghiệp sản xuất ra được (kg)" rules={[{required:true,message:'Bắt buộc nhập'}]} className={styles.col}><InputNumber min={0} style={{width:'100%'}} /></Form.Item>
            </div>
            <div className={styles.row}>
              <Form.Item name="khoiLuongPhuPhamDungChoTrunQue" label="Khối lượng phụ phẩm nông nghiệp dùng cho trùn quế (kg/ngày)" rules={[{required:true,message:'Bắt buộc nhập'}]} className={styles.col}><InputNumber min={0} style={{width:'100%'}} /></Form.Item>
              <Form.Item name="tyLePhuPhamDungChoTrunQue" label="Tỷ lệ % phụ phẩm nông nghiệp dùng cho trùn quế (19g/19f)" rules={[{required:true,message:'Bắt buộc nhập'}]} className={styles.col}><Input /></Form.Item>
            </div>
            <div className={styles.row}>
              <Form.Item name="dienTichNuoiTrunQue" label="Diện tích được sử dụng để nuôi trùn quế (m2/lứa)" rules={[{required:true,message:'Bắt buộc nhập'}]} className={styles.col}><Input /></Form.Item>
              <Form.Item name="chiPhiMuaGiongB" label="Chi phí mua giống (sinh khối trùn quế, tính cho 1m2/lứa)" rules={[{required:true,message:'Bắt buộc nhập'}]} className={styles.col}><Input /></Form.Item>
            </div>
            <div className={styles.row}>
              <Form.Item name="soNgayDeNuoiMotLuaB" label="Số ngày để nuôi một lứa trùn quế (ngày)" rules={[{required:true,message:'Bắt buộc nhập'}]} className={styles.col}><InputNumber min={0} style={{width:'100%'}} /></Form.Item>
              <Form.Item name="khoiLuongTrunQueThuDuoc" label="Khối lượng trùn quế thu được (kg/lứa)" rules={[{required:true,message:'Bắt buộc nhập'}]} className={styles.col}><Input /></Form.Item>
            </div>
            <div className={styles.row}>
              <Form.Item name="khoiLuongPhanTrunQueThuDuoc" label="Khối lượng phân trùn quế thu được (kg/lứa)" rules={[{required:true,message:'Bắt buộc nhập'}]} className={styles.col}><Input /></Form.Item>
              <Form.Item name="congLaoDong" label="Công lao động (số giờ/ngày)" rules={[{required:true,message:'Bắt buộc nhập'}]} className={styles.col}><Input /></Form.Item>
            </div>
            <div className={styles.row}>
              <Form.Item name="gioQuetDonPhanChuongTruoc" label="Khi chưa nuôi trùn quế, trong 1 ngày dành bao nhiêu giờ để quét dọn phân chuồng" rules={[{required:true,message:'Bắt buộc nhập'}]} className={styles.col}><InputNumber min={0} style={{width:'100%'}} /></Form.Item>
              <Form.Item name="gioDonPhanChuongSau" label="Khi nuôi trùn quế, 1 ngày dành bao nhiêu giờ để dọn dẹp phân chuồng dùng cho trùn quế" rules={[{required:true,message:'Bắt buộc nhập'}]} className={styles.col}><InputNumber min={0} style={{width:'100%'}} /></Form.Item>
            </div>
          </div>
          <div className={styles.sectionTitle}>C. Sử dụng phân trùn quế bón cho cây trồng SAU và TRƯỚC khi nuôi Trùn quế (1 vụ cây trồng gần đây nhất)</div>
          <Divider className={styles.divider} />
          <div className={styles.formSectionBg}>
            <div className={styles.row}>
            ...
            <div className={styles.groupedBg}>
                <div className={styles.label}>Cây được trồng tháng/năm nào?</div>
                <div className={styles.row}>
            ...
            <div className={styles.groupedBg}>
                <div className={styles.label}>Diện tích trồng (sào/vụ)</div>
                <div className={styles.row}>
            ...
            <div className={styles.groupedBg}>
              <div className={styles.label}>Khối lượng của từng loại phân bón được bón cho cây trồng (kg)</div>
              <div className={styles.row}>
                <div className={styles.col}>
                  <div className={styles.label}>SAU KHI BÓN PHÂN TRÙN QUẾ</div>
                ...
                <div className={styles.col}>
                  <div className={styles.label}>KHÔNG BÓN PHÂN TRÙN QUẾ</div>
            ...
            <div className={styles.groupedBg}>
              <div className={styles.label}>Số tiền đã chi cho mỗi loại phân bón (đồng)</div>
              <div className={styles.row}>
                <div className={styles.col}>
                  <div className={styles.label}>SAU KHI BÓN PHÂN TRÙN QUẾ</div>
            ...
            <div className={styles.row}>
              <Form.Item name="sauBenhC" label="Cây trồng có bị sâu bệnh tấn công (có/không)" rules={[{required:true,message:'Bắt buộc nhập'}]} style={{flex:'1 1 300px'}}><Input placeholder='Có/Không'/></Form.Item>
          ...
          <div className={styles.sectionTitle}>D. Sử dụng trùn quế làm thức ăn cho vật nuôi SAU và TRƯỚC khi nuôi Trùn quế (1 lứa nuôi gần đây nhất)</div>
          <Divider className={styles.divider} />
          <div className={styles.formSectionBg}>
            <div className={styles.row}>
            ...
            <div className={styles.groupedBg}>
              <div className={styles.label}>Số con vật nuôi (số con/lứa)</div>
              <div className={styles.row}>
            ...
            <div className={styles.groupedBg}>
              <div className={styles.label}>Khối lượng của từng loại thức ăn cho lứa nuôi gần đây (kg)</div>
              <div className={styles.row}>
                <div className={styles.col}>
                  <div style={{flex:'1 1 300px',borderRadius:8,padding:8}}>SAU KHI SỬ DỤNG TRÙN QUẾ LÀM THỨC ĂN</div>
            ...
            <div className={styles.groupedBg}>
              <div className={styles.label}>Số tiền đã chi cho mỗi loại thức ăn cho lứa nuôi gần đây (đồng)</div>
              <div className={styles.row}>
                <div className={styles.col}>
            ...
            <div className={styles.row}>
              ...
              <Form.Item name="vatNuoiBiBenhD" label="Vật nuôi có bị bất kỳ bệnh nào không" rules={[{required:true,message:'Bắt buộc nhập'}]} style={{flex:'1 1 300px'}}><Input placeholder='Có/Không'/></Form.Item>
            </div>
            <div className={styles.row}>
              ...
              <Form.Item name="vatNuoiPhatTrienNhanhHonD" label="Vật nuôi có phát triển nhanh hơn và/hoặc lớn hơn" rules={[{required:true,message:'Bắt buộc nhập'}]} style={{flex:'1 1 300px'}}><Input placeholder='Có/Không'/></Form.Item>
            </div>
            <div className={styles.row}>
